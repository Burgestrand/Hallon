...
module Hallon
  ...
  module Spotify
    ...
    # Session
    # 
    enum :connection_state, [:logged_out, :logged_in, :disconnected, :undefined]
    ...
    attach_function :session_connection_state, :sp_session_connectionstate, [ :pointer ], :connection_state
    ...
    # Link
    # 
    enum :link_type, [:invalid, :track, :album, :artist, :search,
    ...
    attach_function :link_type, :sp_link_type, [ :pointer ], :link_type
    ...
    # Albums
    # 
    enum :album_type, [:album, :single, :compilation, :unknown]
    ...
    attach_function :album_type, :sp_album_type, [ :pointer ], :album_type
    ...
    # Images
    # 
    enum :image_format, [:unknown, -1, :jpeg]
    ...
    attach_function :image_format, :sp_image_format, [ :pointer ], :image_format
    ...
    # Searching
    # 
    enum :radio_genre, {ALT_POP_ROCK: 0x1, FUNK: 0x10, HOUSE: 0x100,
                       POP: 0x1000, SOUL: 0x10000, BLUES: 0x2,
                       HARD_ROCK: 0x20, JAZZ: 0x200, PUNK: 0x2000,
                       TECHNO: 0x20000, COUNTRY: 0x4, HEAVY_METAL: 0x40,
    ...
    # Toplists
    # 
    enum :toplist_type, [:artists, :albums, :tracks]
    enum :toplist_region, [:everywhere, :user]
    
    attach_function :toplistbrowse_create, :sp_toplistbrowse_create, [ :pointer, :int, :int, :string, callback([:pointer, :pointer], :void), :pointer ], :pointer
